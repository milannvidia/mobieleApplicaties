...
class TakePictureScreen extends StatefulWidget {
  ...
  final Function(String) setProfilePicture;
            ...
            await Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => DisplayPictureScreen(
                  changeProfilePicture: widget.setProfilePicture,
...
class DisplayPictureScreen extends StatelessWidget {
  ...
  const DisplayPictureScreen({super.key, required this.imagePath, required this.changeProfilePicture});
